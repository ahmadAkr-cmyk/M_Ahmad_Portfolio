        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building REST APIs, authentication systems, and server-side
                logic using Node.js, Express.js, and MongoDB.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>AI & Frontend</h4>
              <p>
                Generative AI integration, AI automation workflows, and
                polished frontend experiences with React.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
